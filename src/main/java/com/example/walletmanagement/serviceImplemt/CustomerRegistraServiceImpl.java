...
public class CustomerRegistraServiceImpl implements CustomerRegistrationService {
    private final CustomerRegisterRepo customerRegisterRepo;

    @Override
    public CustomerRegistration createCustomerRegister(CustomerRegistration customer) {
        try {
            return customerRegisterRepo.save(customer);
        } catch (Exception e) {
    ...
    @Override
    public Set<CustomerRegistration> getAllPeopleLivingInProvince(Province province) {
        return customerRegisterRepo.findByProvince(province);
    }

    @Override
    public Set<CustomerRegistration> getAllPeopleLivingInDistrict(District district) {
        return customerRegisterRepo.findByDistrict(district);
    }

    @Override
    public Set<CustomerRegistration> getAllPeopleLivingInSector(Sector sector) {
        return customerRegisterRepo.findBySector(sector);
    }

    @Override
    public Set<CustomerRegistration> getAllPeopleLivingInCell(Cell cell) {
        return customerRegisterRepo.findByCell(cell);
    }

    @Override
    public Set<CustomerRegistration> getAllPeopleLivingInVillage(Village village) {
